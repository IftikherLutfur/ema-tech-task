...
const Header = () => {
  return (
    <div className="flex bg-gradient-to-b from-[#1b3c2c] to-black pt-5 flex-col items-center justify-center min-h-screen relative">
      ...
      <h1 className="text-center lg:text-7xl md:text-5xl text-4xl lg:mx-10 md:mx-20 text-white mt-10">
        Strategic Landing Pages That Convert From Just $200
      </h1>
      <p className="text-center opacity-70 lg:mx-52 px-20 text-white mt-10">
      ...
      <div className="px-5 md:px-12 lg:px-36">
